...
<body style="margin: 0px; padding: 0px;">
	...
	<%-- Header Background --%>
	<div style="background-image: url('Images/Header_Background.jpg'); 
	height: 100px; margin: 0px;	width: 100%;">
	...
	<div style="left: 66%; height: 30px; margin-top: -25px; position: relative;
		 top: -50%; width: 345px; ">
		<nav>
			<ul style="list-style-type: none; padding: 0px;">
			
				<li style="border-right: 2px solid white; display: inline;">
					<a href="#" style="margin: 0px 10px;">View Profile</a>
				</li>
				
				<li style="border-right: 2px solid white; display: inline;">
					<a href="#" style="margin: 0px 10px;">Shop</a>
				</li>
